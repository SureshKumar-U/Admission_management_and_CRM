...
export default function Sidebar() {
    ...
    return (
        <aside className="flex  flex-col h-full" style={{ background: "#0c1e3c", minWidth: 230 }}>
            {/* Brand */}
            ...
            <nav className="flex-1 py-2 overflow-y-auto">
                ...
                {navItems?.map((item, i) => {
                    if (item.section) {
                        ...
                        return <div key={i} className="pt-3 pb-1.5 px-2 text-1.5 font-semibold text-[#555d7a] tracking-[0.08em] uppercase">{item.section}</div>;
                    }
