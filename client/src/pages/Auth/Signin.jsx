...
const SiginPage = ()=> {
  ...
  return (
    ...
    <div className="bg-[#141720] border border-[#252a3a] rounded-lg p-9 w-95">
      ...
      <div className="mt-4 text-center text-sm">Dont have an account?  <Link className="text-[#4f8ef7]" to={"/signup"} > SignUp  </Link></div>
      </div>
    </div>
  );
}
